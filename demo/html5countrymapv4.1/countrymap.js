...
var simplemaps_countrymap_mapinfo = {
    ...
    proj: "mercator",
    default_labels: {},
    proj_coordinates: [{lat: 10.416667, x: 543.6, lng: 106.116667, y: 1842.8}, {
        lat: 10.183333,
        x: 468.9,
        lng: 105.566667,
        y: 1875
    }, {lat: 10.266667, x: 471.2, lng: 105.583333, y: 1863.5}],
    initial_view: {x2: 1458.0855000000001, x: -448.1055000000001, y2: 2118.98, y: 0.99}
}
...
!function (e) {
    var t = {};
    (function () {
        var e, t, o, i, n, a, r, s, l, c, m, u = this || Function("return this")(), p = function () {
            "use strict";
            var e, t, o, i, n, a = "linear", r = Date.now || function () {
                return +new Date
            ...
            function h(e, t) {
                var o = y.prototype.filter, i = e._filterArgs;
                c(o, function (n) {
        ...
        p.shallowCopy(p.prototype.formula, {
            ...
            tweenCreated: function (e, n, a, r) {
                ...
                a = n, r = this._tokenData, t.each(r, function (e) {
                    var t = r[e].chunkNames, o = t.length, i = a[e];
                    if ("string" == typeof i) for (var n = i.split(" "), s = n[n.length - 1], l = 0; l < o; l++) a[t[l]] = n[l] || s; else for (l = 0; l < o; l++) a[t[l]] = i;
                    delete a[e]
                ...
                g(e, this._tokenData), g(o, this._tokenData), g(i, this._tokenData), a = n, r = this._tokenData, t.each(r, function (e) {
                    var t = r[e].chunkNames, o = t.length, i = a[t[0]];
                    if ("string" == typeof i) {
    ...
    }("docReady", t), function (e, t, o) {
        void 0 !== e && void 0 !== e.log || ((e = {}).log = function () {
        }), "function" != typeof t.create && (t.create = function (e) {
            function t() {
            }
    ...
    var o = function () {
            ...
            function t(e, t) {
                var o = e[0], i = e[1], n = Raphael.transformPath("M" + o + "," + i, t).toString(),
                    a = /M(-?\d+.?\d*),(-?\d+.?\d*)/.exec(n);
                return [a[1], a[2]]
            }
            ...
            return {
                min: i, max: n, addEvent: function (e, t, o) {
                    ...
                    function t(e, t) {
                        if (e.currentStyle) var o = e.currentStyle[t]; else window.getComputedStyle && (o = window.getComputedStyle(e, null)[t]);
                        return o
                    }
                    ...
                    var a = [e.x, e.y], r = [e.x2, e.y], s = [e.x, e.y2], l = [e.x2, e.y2], c = t(a, o), m = t(r, o),
                        u = t(s, o), p = t(l, o), d = [c[0], m[0], u[0], p[0]], _ = [c[1], m[1], u[1], p[1]], h = i(d),
                        f = n(d), v = i(_), y = n(_);
                    return {x: h, y: v, x2: f, y2: y, width: f - h, height: y - v}
                }, rotate: t, bbox_union: function (e) {
                    for (var t = [], i = [], n = [], a = [], r = 0; r < e.length; r++) {
                        var s = e[r];
                        t.push(s.x), i.push(s.x2), a.push(s.y), n.push(s.y2)
                    }
                    var l = o.min(t), c = o.max(i), m = o.min(a), u = o.max(n);
                    return {x: l, x2: c, y: m, y2: u, width: c - l, height: u - m}
                }, distance: function (e, t) {
                    var o = e.x, i = e.y, n = t.x - o, a = t.y - i;
                    ...
                    var t = document.getElementsByTagName("head")[0], o = document.createElement("style");
        ...
        }(), i = !!window[e + "_mapdata"] && window[e + "_mapdata"], n = !!window[e + "_mapinfo"] && window[e + "_mapinfo"],
        a = e.substring(0, e.length - 3).replace("simplemaps_", ""), r = !0, s = !1, l = !1, c = [], m = {
    ...
    function p() {
        var e = this, i = e.mapdata, n = e.mapinfo;
        if (i && n) {
            var c, u, p, d, _, h, f, v, y, g, b, x, w, k, z, M, E, A, C, T, S, B, O, F, I, P, R, j, N, L, D, H, q, W, Y,
                V, Q, X, U, Z, G, J, K, $, ee, te, oe, ie, ne, ae, re, se = e.hooks, le = e.plugin_hooks,
            ...
            var me, ue, pe, de, _e, he, fe, ve, ye, ge, be, xe, we, ke, ze, Me, Ee, Ae, Ce, Te, Se, Be, Oe, Fe, Ie, Pe,
                Re, je, Ne, Le, De, He, qe, We, Ye, Ve, Qe, Xe, Ue, Ze, Ge, Je, Ke, $e, et, tt, ot, it, nt, at, rt, st,
                lt, ct, mt, ut, pt, dt, _t, ht, ft, vt, yt, gt, bt, xt, wt, kt, zt, Mt, Et, At, Ct, Tt, St, Bt, Ot, Ft,
                It, Pt, Rt, jt = !1, Nt = !1, Lt = !1, Dt = !1, Ht = !1, qt = !1, Wt = !1, Yt = !1, Vt = !1, Qt = {
                    ...
                    if (null == i && (i = !1), "state" == i) var n = e.sm.parent; else if ("region" == i) n = ft[e.sm.parent.sm.region]; else n = Yo(e.sm.parent);
                    var a;
                    ...
                    Xt(e, t, !1, a)
                }, Zt = !1, Gt = function (e, t) {
                    if (e) {
                        var i = !!(e.sm.image || me && g);
                        if (Rt.hide(), Vo(e)) e.sm.ignore_hover || e.animate(e.sm.attributes, D, n), e.animate(e.sm.adjacent_attributes, D, n), Qo(e, "out", !0); else {
                ...
                }, Jt = !1, Kt = !1, $t = function () {
                    So()
                }, eo = !1, to = function (e, t) {
                    if (!eo || e || t) {
                        eo = !0;
                        var i = function (t) {
                            var i = ne ? event.clientX + document.documentElement.scrollLeft : t.pageX,
                                n = ne ? event.clientY + document.documentElement.scrollTop : t.pageY, a = o.findPos(_e),
                                r = a[0], s = a[1], l = vt.sm.zooming_dimensions, c = l.r * be / we, m = l.r * xe / we,
                                u = l.x / we + c * (i - r) / be, p = l.y / we + m * (n - s) / xe,
        ...
        function fo(e) {
            if (he.style.width = "", fe.style.width = "", b ? ((be = he.offsetWidth) < 1 && (be = he.parentNode.offsetWidth), fe.style.width = be + "px") : (be = void 0 === _.width ? 800 : _.width, he.style.width = be + "px"), be *= 1, n.calibrate ? ((Me = {}).x = -1 * n.calibrate.x_adjust, Me.y = -1 * n.calibrate.y_adjust, Me.x2 = Me.x + n.calibrate.width, Me.y2 = (Me.x2 - Me.x) / n.calibrate.ratio) : Me = n.initial_view, ke = Me.x2 - Me.x, ze = Me.y2 - Me.y, xe = be / (Ce = ke / ze), Ee = ke / 1e3, _e.style.height = xe + "px", !e) {
                if (we = be / ke, Ae = 1, y) {
                    var t = [];
                    ...
                    var r = o.bbox_union(t), s = .5 * (r.x2 + r.x) * we, l = .5 * (r.y2 + r.y) * we;
                    ge = "r" + y + "," + s + "," + l;
        ...
        function yo() {
            var t, o, i = _.navigation_color ? _.navigation_color : "#f7f7f7",
                ...
                p = void 0 === _.navigation_size_mobile ? pe * u : _.navigation_size_mobile, d = me ? p : u,
            ...
            !function () {
                ...
                function _() {
                    ...
                    j || Ue.hide(), de.style.left = v + "px", de.style.top = v + "px", g && function () {
                        Je = Raphael(ve, d, 2 * d + v);
                        var t = m.plus, o = m.minus, r = m.rounded_box, s = Je.path(r).attr({
                            fill: i,
                            "stroke-width": 1,
                            stroke: n,
                            "stroke-opacity": 1,
                        ...
                        function _(e, t) {
                            if (void 0 === t && (t = "z"), z && "region" != z.sm.type) St.call(z, !0, function () {
                                z = !1, _(e)
                            }); else {
                                if ("z" == t && !function (e) {
                                    var t = vt.sm.zooming_dimensions.w / e, o = e < 1;
                                    if (-1 != x && ("manual" == vt.sm.type || w)) {
                                        var i = ft[x].sm.zooming_dimensions.w, n = t > i - 1;
                                        if (o && n) {
                                            var a = Io(vt, ft[x]);
                                ...
                                }).sm.zooming_dimensions = dt, vt.sm.bbox = {
                                    x: dt.x / we,
                                    y: dt.y / we,
                                    width: dt.w / we,
                                    height: dt.h / we
                                ...
                                var i = function (e, t) {
                                    var o = vt.sm.zooming_dimensions.w, i = vt.sm.zooming_dimensions.h,
                                        n = vt.sm.zooming_dimensions.x, a = vt.sm.zooming_dimensions.y;
                                    if ("x" == t) var n = vt.sm.zooming_dimensions.x + vt.sm.zooming_dimensions.w * e; else if ("y" == t) var a = vt.sm.zooming_dimensions.y + vt.sm.zooming_dimensions.h * e; else var o = vt.sm.zooming_dimensions.w / e,
                        ...
                        Ge.transform(c), ve.style.top = f + 2 * v + "px", ve.style.left = v + "px", (Ge = Te.set()).push(u, p), Ke = function () {
                            _(O)
                        }, et = function (e, t) {
                            _(e, t)
                        }, $e = function () {
        ...
        function go() {
            ...
            !function () {
                ...
                var t = "no" == _.import_labels ? {} : n.default_labels, o = function (o) {
                ...
                var e = {}, t = me ? _.scale_limit_mobile ? _.scale_limit_mobile : .4 : .0625;
        ...
        function bo(e, t) {
            if ("lambert" == n.proj) var i = function (e) {
                var t = .017453293, o = Math.PI, i = e.lat * t, n = e.lng * t, a = 33 * t,
            ...
            function r(e) {
                var t, o, i = function (e) {
                        return e < 0 ? -1 : 1
                    }, n = i(e.lng), a = i(e.lat), r = Math.abs(e.lng), s = Math.abs(e.lat),
                    l = (t = 5, o = s - 1e-10, Math.floor(o / t) * t), c = (l = 0 == s ? 0 : l) / 5, m = (l + 5) / 5,
                    u = (s - l) / 5,
            ...
            function l(e, t, n, a) {
                var r, s, l, c, m, u, p, d, _, h, f, v, y, g, b, x = i(e), w = i(t), k = i(n), z = i(a),
                    M = o.distance(x, w), E = o.distance(x, k), A = o.distance(w, k) / o.distance(t, n), C = M / A,
                    T = E / A,
        ...
        function xo(e) {
            ...
            var t, i = o.rotate_bbox(e.sm.bbox, Pe), n = i.x, a = i.y, r = i.width, s = i.height, l = e.sm.zp,
                c = ke * we, m = ze * we;
            return n -= .5 * (r / l - r), a -= .5 * (s / l - s), (r /= l) / (s /= l) > Ce ? (a -= (m * (t = r / c) - s) / 2, s = r / Ce) : (n -= (c * (t = s / m) - r) / 2, r = s * Ce), {
                x: n,
                y: a,
                w: r,
                h: s,
        ...
        function Mo(e, t) {
            var i = e.sm.display, a = t.sm.type;
            if ("all" == i) return !0;
        ...
        function Ao(e, t) {
            var i = e.sm.type;
            Ue.hide(), function (e, t) {
                We.hide(), We.forEach(function (o) {
            ...
            }(e, t), o.x_in_array(i, ["state", "region", "out"]) && zo(), "region" == i ? wo(e) : "state" == i ? wo(ft[e.sm.region]) : "manual" == i && qe.forEach(function (e) {
                -1 != e.sm.id && (e.sm.zooming_dimensions.r > Ae && e.sm.zoomable ? wo(e) : ko(e))
            }), "out" != i && "manual" != i ? (He.stop(), De.stop(), He.attr({"fill-opacity": W}), De.attr({"fill-opacity": W}), e.stop(), e.attr({"fill-opacity": 1}), e.sm.labels.forEach(function (e) {
                e.sm && e.sm.pill && (e.sm.pill.stop(), e.sm.pill.attr({"fill-opacity": 1}))
            }), e.animate({"stroke-width": e.sm.border_hover_size * (be / ke) * Ee * 1.25}, 1e3 * S)) : (He.attr({"fill-opacity": 1}), De.attr({"fill-opacity": 1})), He.animate({"stroke-width": Z * (be / ke) * Ee * 1.25}, 1e3 * S)
        }
        ...
        function Bo(i, n, a) {
            if (!Dt) {
                ...
                var r = To(i.sm.zooming_dimensions), s = To(vt.sm.zooming_dimensions);
                if (Ae = i.sm.zooming_dimensions.r, Ao(i, n), ie || me && !B || n) dt = r, Te.setViewBox(r.x, r.y, r.w, r.h, !1), c(); else {
                    ...
                    pt = l.tween({
                        from: s, to: r, duration: 1e3 * S, easing: "easeOutQuad", step: function (e) {
                            !function (e) {
        ...
        function Fo(e) {
            ...
            var n = e.sm.url ? e.sm.url : "", a = n, r = "javascript:" == a.substring(0, 11),
        ...
        function Io(e, t) {
            ...
            var i = t.sm.bbox, n = i.x * we, a = i.y * we, r = i.x2 * we, s = i.y2 * we, l = o.x + o.w / 2,
                c = o.y + o.h / 2;
            return l > n && c > a && l < r && c < s
        }

        function Po(e, t) {
            var i = t.hover ? "_hover" : "", a = ce + "_pattern_" + e.sm.id + i, r = document.getElementById(a);
            r && o.delete_element(r);
            var s = _e.firstChild, l = s.namespaceURI, c = s.querySelector("defs"),
                m = document.createElementNS(l, "pattern"), u = e.sm.id;
            ...
            var h = t.image_position, f = "auto" == t.image_size, v = "repeat" == h, g = "manual" == h,
                b = "center" == h, x = Raphael.pathBBox(n.paths[u]), w = x.x2 - x.x, k = x.y2 - x.y, z = w / k;
            return Raphael._preload(t.image_url, function () {
                var e = this.offsetWidth, o = this.offsetHeight, i = e / o;
                var n, a, r = function () {
                    var n = t.image_size;
        ...
        function Ro(e) {
            ...
            for (var o in _t = function (e) {
                var o = !ht[e], i = tt[e], a = i.path ? i.path : n.paths[e], r = o ? Te.path(a) : ht[e];
                ...
                var s = {
                    ...
                    c = i.border_hover_size ? i.border_hover_size : Z, m = c * we * Ee * 1.25,
        ...
        function No(e) {
            if (e || (ft = {}), E) for (var t in E) {
                var i = it[t], n = E[t], a = e ? ft[t] : Te.set();
                if (!e) {
            ...
            if (!e) {
                ...
                var d = o.clone(Me);
                if (d.width = d.x2 - d.x, d.height = d.y2 - d.y, p.sm.bbox = d, p.sm.zooming_dimensions = xo(p), vt = p, "object" == typeof x ? ((yt = {}).sm = {
                    type: "manual",
                    zp: 1,
                    bbox: x
                }, yt.sm.zooming_dimensions = xo(yt), x = -1, w = !1) : -1 == x || x in ft || (x in ht ? (Vt = ht[x], w = !1) : console.log("The initial_zoom is not the id of a region or state"), x = -1), v) {
                    ft[-2] = {};
                    var _ = ft[-2];
                    _.sm = {type: "manual", zp: 1};
                    var h = xo(ft[x]), f = h.w, y = h.h, g = h.w * (v - 1) * .5, b = h.h * (v - 1) * .5;
        ...
        function Lo(e) {
            ...
            var i = .5 * t.width, n = .5 * t.height, a = e.sm.point0;
            return {x: a.x - i, y: a.y - n, x2: a.x + i, y2: a.y + n, width: t.width, height: t.height}
        }

        function Do() {
            for (var e in o.clear_sets([Qe, Se, De]), gt = {}, wt = {}, bt = {}, rt = rt.reverse(), xt = function (e) {
                var t = rt[e], i = !1, a = !1;
                if (rt.hasOwnProperty(e)) {
                    var r = !gt[e], s = Te.set(), l = {x: 1 * t.x, y: 1 * t.y}, c = {}, m = !1, u = !1;
                    if ("state" == t.parent_type ? m = ht[t.parent_id] : "region" == t.parent_type ? m = ft[t.parent_id] : "location" == t.parent_type && (m = kt[t.parent_id]), !t.x && !t.y && m) if ("location" == m.sm.type) a = !0, c.x = m.sm.x, c.y = m.sm.y, l = m.sm.point0, i = !0, m.sm.auto_size && (u = !0); else if ("state" == m.sm.type) {
                        var p = m.sm.bbox;
                    ...
                    if (t.parent_type, m) {
                        ...
                        var y = {
                            ...
                            opacity: t.opacity
                        }, g = {fill: t.hover_color, opacity: t.hover_opacity}, b = {fill: t.color, opacity: t.opacity};
                        if (m.sm.inactive && (y.cursor = "default"), v.attr(y), v.sm.attributes = y, v.sm.over_attributes = g, v.sm.out_attributes = b, v.sm.type = "label", v.sm.id = e, v.sm.scale = i || t.scale, v.sm.scale_limit = t.scale_limit, v.sm.x = c.x, v.sm.y = c.y, v.sm.point0 = l, v.sm.line_x = t.line_x, v.sm.line_y = t.line_y, v.sm.line = !1, v.sm.rotate = t.rotate, v.transform(qo(v, we)), t.display ? v.sm.display = t.display : "region" == t.parent_type ? v.sm.display = "out" : "location" == t.parent_type ? v.sm.display = m.sm.display : v.sm.display = _.labels_display ? _.labels_display : "all", v.sm.display_ids = !!t.display_ids && t.display_ids, (t.line || t.pill || u) && (v.sm.bbox = Lo(v)), "auto" == t.display && "state" == t.parent_type) {
                            ...
                            for (var z in x) {
                                var M = x[z], E = Lo(v), A = E.width * M * .5, C = E.height * M * .5,
                                    T = .5 * (E.x2 + E.x), S = .5 * (E.y2 + E.y), B = T + A, O = (h = S - C, S + C),
                                    F = (d = T - A) > k.x && B < k.x2, I = h > k.y && O < k.y2;
                                if (F && I) {
                                    var P = Raphael.isPointInsidePath(w, d, h), R = Raphael.isPointInsidePath(w, B, h),
                                        j = Raphael.isPointInsidePath(w, d, O), N = Raphael.isPointInsidePath(w, B, O),
                                        L = P && R && j && N, D = E.width / M < ke;
                                    if (L && D) {
                                        v.sm.display = M;
                                        break
                                    }
                        ...
                        if (t.line) {
                            var H = Ho(v), q = Te.path(H), W = t.line_size * Ee * we * 1.25,
                        ...
                        if ("out" != v.sm.display && "all" != v.sm.display || v.sm.hide ? s.hide() : Ie.push(s), "location" != v.sm.parent.sm.type || v.sm.line || Oe.push(s), Qe.push(s), bt[e] = s, ie || v.node.setAttribute("class", "sm_label_" + e), u) {
                            var K = (_.location_auto_padding ? 1 + 2 * _.location_auto_padding : 1.3) * v.sm.bbox.width / Ee,
                                $ = (oe = v.sm.parent).sm.labels, ee = oe.sm.shape_type;
        ...
        function Ho(e) {
            var t = e.sm.bbox, i = t.x2 - t.x, n = t.y2 - t.y, a = e.sm.scale ? Ae : 1, r = .5 * (1 - a) * i,
                s = .5 * (1 - a) * n, l = e.sm.line_x, c = e.sm.line_y, m = !l || !c, u = e.sm.parent.sm.type;
            ...
            var d = {x: l, y: c}, _ = [];
            _.push({x: t.x2 - r, y: .5 * (t.y + t.y2)}), _.push({
                x: t.x + r,
                y: .5 * (t.y + t.y2)
            }), _.push({x: .5 * (t.x + t.x2), y: t.y + s}), _.push({x: .5 * (t.x + t.x2), y: t.y2 - s});
            var h = {};
            for (var f in _) {
        ...
        function qo(e, t, o, i, n, a) {
            var r = void 0 === i ? e.sm.x : i, s = void 0 === n ? e.sm.y : n;
        ...
        function Wo(e) {
            ...
            for (var t in o.clear_sets([We]), kt = {}, zt = function (e) {
                var t = "center", n = ot[e];
                ...
                var s = ot[e].type, l = n.size * Ee;
                if (n.x && n.y) (c = {}).x = n.x, c.y = n.y; else var c = bo(n.lat, n.lng);
                var m = o.rotate([c.x, c.y], Pe), u = {x: m[0], y: m[1]};
                if ("auto" == n.size) {
                    var d = {sm: {}};
                    return d.sm.display = n.display, d.sm.auto_size = !0, d.sm.type = "location", d.sm.hide_label = !1, d.sm.labels = [], d.sm.point0 = c, d.sm.x = u.x, d.sm.y = u.y, d.sm.shape_type = s, d.sm.id = e, void (kt[e] = d)
                }
                if ("circle" == s) var _ = Te.circle(u.x, u.y, .5 * l), h = {
                    x: u.x - .5 * l * Ae,
                    y: u.y - .5 * l * Ae,
                    x2: u.x + .5 * l * Ae,
                    y2: u.y + .5 * l * Ae
                    ...
                    if (Raphael._preload(y, function () {
                        var e = this.width / this.height, o = l, i = o * e, n = u.x - i / 2,
        ...
        function Vo(t) {
            var o = e.zoom_level, i = e.zoom_level_id;
            ...
            Bt = function () {
                ...
                if (e.sm.pulse || t) {
                    ...
                    if (!("location" != e.sm.type || "image" == o || Ae < .05)) {
                        ...
                        var r = e.sm.scale ? Ae : 1, s = .5 * (n - 1) * e.sm.size * r * we,
                ...
                if (!ie || !ne) for (var t = Array.isArray(e) ? e : [e], o = 0; o < t.length; o++) {
                    var i = ht[t[o]];
                    if (!i || !i.sm || Ae < .05) return;
                    i.sm.shape_type;
                ...
                if (io(), ri(), (this.id || "set" != !this.type) && !Zt && !co) {
                    var e = Yo(this);
                    if (e.sm.on_click) var t = !0;
                    if (jt = e.sm.popup_off, !(Ht || qt || Dt || M && re)) {
                        if (Jt && !k) return !1;
                        if (Jt = this, e && (function (e) {
                ...
                if (t && "function" == typeof t || (t = !1), !Dt && !co && (Jt = !1, this.id || "set" != !this.type)) {
                    var o = Yo(this);
                    if (o && !o.sm.inactive) if (ao(o), re) M && !0 !== e || (Gt(o, t), Kt = o); else {
                        if (Rt.hide(), Vo(o)) {
                            if (Dt) return !1;
            ...
            Ct = function (o) {
                if (!(Dt || Ht || qt)) {
                    ...
                    if (!i.sm.inactive && (so(i, o), !e.ignore_clicks)) {
                        ...
                        if (re && Rt.update_pos(), jt = i.sm.popup_off, !i.sm.zoomable || "region" != i.sm.type && vt == i && "out" != i.sm.type) if (re) {
                ...
                if (void 0 === e && (e = !1), uo("back", []), ("out" == vt.sm.type || "region" == vt.sm.type && w) && j) window.location.href = "javascript:" + j; else if (V && "state" == vt.sm.type && vt.sm.region) z ? St.call(z, !0, function () {
                    ...
                    var t = Io(vt, ft[x]), o = "manual" == vt.sm.type && t ? ft[x] : ft[-1];
        ...
        function Jo(e) {
            if (!e) {
                ae ? (He.mouseup(Ct), je.mouseup($t), Ue.mouseup(It), je.mouseup(ri)) : (He.hover(Tt, St), He.click(Ct), je.click($t), Ue.click(It), je.hover(ri, ri)), b && function () {
                    function e() {
                        Ko()
                    }
                    ...
                    }, window.addEventListener ? (window.addEventListener("resize", Pt, !1), window.addEventListener("orientationchange", Pt, !1)) : (window.attachEvent("resize", Pt, !1), window.attachEvent("orientationchange", Pt, !1));
                    ie && (document.body.onresize = function () {
                        e()
                    })
                }(), g && (He.touchstart(Ct), He.touchend(Ct), Ue.touchend(Ft), function () {
                    function e(e) {
                        var o = Uo(e), a = o.x, r = o.y, s = (i - a) * t.r, l = (n - r) * t.r, c = 5 * t.r;
                        return (Math.abs(s) > c || Math.abs(l) > c) && (Ht = !0), {
                            x: t.x + s,
                            y: t.y + l,
                            w: t.w,
                            h: t.h,
                    ...
                    function l(t) {
                        ...
                        var o = e(t);
                        Te.setViewBox(o.x, o.y, o.w, o.h), dt = o, (vt = {sm: {}}).sm.zooming_dimensions = dt, vt.sm.type = "manual", a = !1, setTimeout(function () {
                            Ht = !1
                        }, 1), Ue.show()
                    }
                ...
                }(), Zo()), he.mouseIsOver = !1, he.onmouseover = function () {
                    this.mouseIsOver = !0
        ...
        function Ko() {
            if (!(he.offsetWidth < 1)) {
                ...
                He && We && (He.forEach(function (t) {
                    ...
                    "image" != ot[e.sm.id].type && (e.sm.attributes["stroke-width"] = ot[e.sm.id].border * (be / ke) * Ee * 1.25, e.sm.over_attributes["stroke-width"] = ot[e.sm.id].hover_border * (be / ke) * Ee * 1.25, e.attr({"stroke-width": e.sm.attributes["stroke-width"]}))
        ...
        function ti(t) {
            ...
            (i = e.mapdata, n = e.mapinfo, _e && delete window.paper, vi(), function () {
                ...
                var e = document.getElementsByTagName("script"), t = e[e.length - 1].src,
                ...
                return e > 8
            }()) ? alert("The continent map can't be used with other data.") : (po(), function () {
                ...
                if (l) {
                    ...
                    t.href = "https://www.openstreetmap.org/copyright", t.title = "Background © OpenStreetMap contributors", t.innerHTML = s ? "| OSM" : "&copy; OSM", t.style.cssText = e, t.style.marginLeft = ".5em", Lt.appendChild(t)
                }
                if (s) {
                ...
                create: function () {
                    ...
                    if (O) {
                        ...
                        if (o && o.sm.on_click && ("yes" == I || "auto" == I && be < 401) || i) {
                            ...
                            var n = be - D > 0 ? .5 * (be - D) : 0, a = xe - N > 0 ? .5 * (xe - N) : 0;
                ...
                Wo(), Do(), function () {
                    ...
                    if (e) {
                        for (var t in e) {
                            var o = e[t], n = mt[t], a = n.size * (be / ke) * Ee * 1.25, r = !1;
                            if (n.origin_location && n.destination_location) {
                                var s = kt[n.origin_location].sm.point0, l = kt[n.destination_location].sm.point0;
                            ...
                            var d = r || o.path, _ = Te.path(d);
                            _.transform(Pe), _.attr({
                                stroke: n.color,
                                fill: "none",
                                cursor: "pointer",
                                ...
                                "stroke-linejoin": "round",
                                "stroke-miterlimit": 4
                            }), _.sm = {}, _.sm.size = n.size, _.sm.bbox = _.getBBox(!0), ie || _.node.setAttribute("class", "sm_line_" + t), Fe.push(_)
                        }
                        Fe.hide()
                    }
                }(), function () {
                    ...
                    var t = void 0 === _.states_title ? "States" : _.states_title,
                        ...
                        n = void 0 === _.locations_title ? "Locations" : _.locations_title, a = {
                            state: {title: t, array: ht},
                            location: {title: n, array: kt},
                            region: {title: i, array: ft}
                        };
                    for (var r in a) {
                        var s = a[r], l = Object.size(s.array);
                        if (!(l < 1 || l < 2 && "region" == r)) {
                            ...
                            c.onchange = o.callback_closure({entry: s, dropdown: c}, function (e) {
                                ...
                                var i = o.array[t.value], n = i.sm.type, a = function () {
                                    var e = i.sm.on_click;
                                    i.sm.on_click = !0, i.sm.content = Fo(i), si(i.sm.type, i.sm.id, function () {
                    ...
                    if (!(!i.legend || !i.legend.entries || i.legend.entries.length < 1 || ne && ie)) {
                        ...
                        var s = i.legend.html;
                        s && "no" != s ? map_legend.innerHTML = s : function () {
                            for (var e in a) {
                                var o = a[e];
                ...
                }(), zo(), Go(), Rt.create(), Xo(), Jo(), $o(), yi(), uo("complete", []), o.isFunction(t) && t(), io()
            }, 1))
        }
        ...
        function ai(e, t, o) {
            ...
            var i = {sm: {type: "manual", zp: t}}, n = kt[e], a = n.sm.size * we * t, r = a * ze / ke,
                s = n.sm.x - .5 * a, l = n.sm.y - .5 * r, c = a / (ke * we);
            i.sm.zooming_dimensions = {x: s, y: l, w: a, h: r, r: c}, Bo(i, !1, function () {
                o(), Ue.show()
            })
        }
        ...
        function si(t, o, i) {
            ...
            }), "state" == t) var n = ht[o]; else if ("region" == t) n = ft[o]; else n = kt[o];
            var a = n.sm.on_click, r = vt.sm.zooming_dimensions;
            if ("location" != t) {
                var s = n.sm.bbox, l = .5 * (s.x + s.x2), c = .5 * (s.y + s.y2);
                l *= we, c *= we
            } else l = n.sm.x, c = n.sm.y;
            var m = (l - r.x) / Ae, u = (c - r.y) / Ae, p = m > 1.1 * be || u > 1.1 * xe,
                d = !n.sm.region && "region" == e.zoom_level;
            return p || d ? oi("-1", function () {
                si(t, o, i)
            }) : n.sm.region && "out" == e.zoom_level ? oi(n.sm.region, function () {
                si(t, o, i)
        ...
        function vi() {
            e.calibrate = Oo, e.get_xy = oo, e.proj = bo, e.load = ti, e.region_zoom = oi, e.state_zoom = ii, e.zoom_in = !1, e.zoom_out = !1, e.location_zoom = ai, e.back = hi, e.popup = si, e.pulse = li, e.pulse_state = fi, e.popup_hide = ci, e.zoom_level = "out", e.ignore_clicks = !1, e.zoom_level_id = !1, e.disable_urls = di, e.enable_urls = _i, e.disable_popups = ui, e.enable_popups = pi, e.refresh = ei, e.refresh_state = mi, e.loaded = !0
        }
    ...
    window[e] = u, t.docReady(function () {
        ...
        }("ready"), !window[e].loaded) for (var t = 0; t < c.length; t++) {
            var o = c[t];
